          ...
          <div className="d-sm-flex justify-content-between align-items-start">
            ...
            <div className="d-sm-flex justify-content-xl-between align-items-center mb-2">
              <div className="btn-group d-none d-xl-flex bg-white p-3" role="group" aria-label="Basic example">
                ...
                <button type="button" className="btn btn-link text-dark py-0 font-weight-medium border-right">1 Mois</button>
                <button type="button" className="btn btn-link text-light font-weight-medium py-0">3 Mois</button>
              </div>
              <div className="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
                <Dropdown alignRight>
                  ...
                  <Dropdown.Menu>s
                    <Dropdown.Item>24 Déc 2021 - 24 Jan 2021</Dropdown.Item>
                    <Dropdown.Item>24 Jan 2022 - 24 Fév 2022</Dropdown.Item>
                    <Dropdown.Item>24 Fév 2022 - 24 Mars 2022</Dropdown.Item>
                    <Dropdown.Divider></Dropdown.Divider>
                    <Dropdown.Item>24 Mars 20 - 24 Avril 2019</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            </div>
              ...
              <div className="justify-content-between align-items-center tab-transparent">
                <Tabs defaultActiveKey="Business" className="nav">
                 {/*  <Tab eventKey="Users" title="Users" className="test-tab" disabled>  
                    ...
                    <Tab eventKey="Business" title="Bilan">
                      <div>
                        <div className="row">
                          <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 text-dark font-weight-normal">Global Commandes</h5>
                          ...
                          <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 text-dark font-weight-normal">Global Commandes Livrées</h5>
                          ...
                          <div className="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 text-dark font-weight-normal">Global Commandes Annullées</h5>
                                  ...
                                  <div className="col-lg-3 col-sm-4 grid-margin  grid-margin-lg-0">
                                    <div className="wrapper pb-5 border-bottom">
                                      <div className="text-wrapper d-flex align-items-center justify-content-between mb-2">
                                        <p className="mb-0 text-dark">Profit Total</p>
                                        <span className="text-success"><i className="mdi mdi-arrow-up"></i>2.95%</span>
                                      </div>
                                      <h3 className="mb-0 text-dark font-weight-bold">MAD 9255687</h3>
